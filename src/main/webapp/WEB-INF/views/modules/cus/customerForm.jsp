...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cus/customer/">客户信息管理列表</a></li>
		<li class="active"><a href="${ctx}/cus/customer/form?id=${customer.id}">客户信息管理<shiro:hasPermission name="cus:customer:edit">${not empty customer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cus:customer:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="customer" action="${ctx}/cus/customer/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="sex" items="${fns:getDictList('cus_sex')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="cus:customer:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

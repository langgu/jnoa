...
public class Supplier extends DataEntity<Supplier> {
	...
	private String supName;		// 供应商名称（supplier）
	private String regCapital;		// 注册资本（万元）(registered capital )
	...
	private Date beginSetTime;		// 开始 成立时间
	private Date endSetTime;		// 结束 成立时间
	...
	@Length(min=0, max=255, message="供应商名称（supplier）长度必须介于 0 和 255 之间")
	...
	public Date getBeginSetTime() {
		return beginSetTime;
	}

	public void setBeginSetTime(Date beginSetTime) {
		this.beginSetTime = beginSetTime;
	}

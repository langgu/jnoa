 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/cus/customer")
public class CustomerController extends BaseController {
	...
	@RequiresPermissions("cus:customer:view")
	...
	public String list(Customer customer, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/cus/customerList";
	}
	...
	public String form(Customer customer, Model model) {
		...
		return "modules/cus/customerForm";
	}

	@RequiresPermissions("cus:customer:edit")
	...
	public String save(Customer customer, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/cus/customer/?repage";
	}
